...
export interface ApiBusinessBusiness extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    activities: Schema.Attribute.Component<'business.activity', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    activities_layout: Schema.Attribute.Enumeration<
    ...
    > &
      ...
      Schema.Attribute.DefaultTo<'layout1'>;
...
export interface ApiHistoryPageHistoryPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    achievements: Schema.Attribute.Component<'about.achievement', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    history_of_development: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    milestones: Schema.Attribute.Component<'about.history', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    features: Schema.Attribute.Component<'about.feature', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    partners: Schema.Attribute.Component<'about.partner', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiMemberMember extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    functions: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiOrganizationPageOrganizationPage
  ...
  attributes: {
    ...
    directly_affiliated_agencies: Schema.Attribute.Component<
      'about.name-card',
      true
    > &
      Schema.Attribute.SetPluginOptions<{
    ...
    subsidiary_companies: Schema.Attribute.Component<'about.name-card', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiVisionPageVisionPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    objectives: Schema.Attribute.Component<'about.name-card', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
